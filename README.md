# Catboost Classifier in Scikit-Learn with Shapley Explanations
## Project Description
...
- A **Catboost Classifier** algorithm built using **catboost** python package.
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Catboost Classifier model implemented using **catboost** python library.
